...
from analyzers.java_analyzer import analyze_java  # Make sure to import your analyzer function correctly
...
class TestJavaAnalyzer(unittest.TestCase):
    ...
    def test_analyze_maven_project_dockerised(self, mock_check_file, mock_fetch_file):
        ...
        mock_check_file.side_effect = lambda url, file: file in ['pom.xml', 'Dockerfile']
        pom_file_content = """
